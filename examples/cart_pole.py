...
class AdvantageMultiStepAgent(QAgent):
    def build_model(self):
    ...
    def model_custom_objects(self, **kwargs):
        return super(AdvantageMultiStepAgent, self).model_custom_objects(
            AdvantageAggregator=AdvantageAggregator, **kwargs)


AGENT_REGISTRY = dict(
    dqn=CartPoleAgent, duel=CartPoleAdvantageAgent, rduel=AdvantageMultiStepAgent
)
